        ...
        <div className="block md:hidden">
          <div className="flex flex-col gap-4">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <a
                href="https://www.instagram.com/zulfahmiridha_/"
                target="_blank"
              ...
              >
                ...
                >
                  ...
                  <div className={`text-xs relative z-10 ${isLight ? 'text-slate-700' : 'text-gray-300'}`}>@zulfahmiridha_</div>
                </div>
              </a>
            </div>
          </div>
          ...
          <div className="grid grid-cols-4 grid-rows-4 gap-2 xl:gap-4 h-screen max-h-[800px]">
            ...
            >
              ...
              >
                ...
                <div className={`text-sm relative z-10 ${isLight ? 'text-slate-700' : 'text-gray-300'}`}>@zulfahmiridha_</div>
              </div>
            </a>
          </div>
        </div>
