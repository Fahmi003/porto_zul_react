...
const Journey = () => {
  ...
  const timelineData = [
    {
      ...
      childhoodPhotos: ["/img2/bayi.jpg", "/img2/bayi2.jpg", "/img2/ddk.jpg"]
    },
    {
      year: "2005",
      title: "TK Al-huda",
      description: "Memulai pendidikan di Taman Kanak-kanak Al-huda",
      childhoodPhotos: ["/img2/Tk1.jpg", "/img2/klr.jpg", "/img2/kkk1.jpg"],
      logo: "/img2/min2.png",
    },
    {
      year: "2006-2012",
      title: "MIN Simpang Empat Upah",
      description: "Melanjutkan pendidikan dasar di Min Simpang Empat Upah",
      logo: "/img2/min2.png",
    },
    {
      year: "2012-2015",
      title: "MTS MUQ Langsa",
      description: "Menempuh pendidikan Tsanawiyah di Pasantren MUQ Langsa",
      logo: "/img2/muq.jpeg",
    },
    {
      year: "2015-2018",
      title: "MA MUQ Langsa",
      description: "Menempuh Pendidikan Aliyah di Pasantren MA MUQ Langsa",
      logo: "/img2/muq.jpeg",
      organizations: [
        { name: "OSIS" },
        { name: "Pramuka" },
    ...
    {
      year: "2018-2019",
      title: "IAIN Zawiyah Cot Kala Langsa ",
      description: "Menempuh Perkuliahan dengan Jurusan Pendidikan Matematika",
      logo: "/img2/cotkala.jpeg",
    },
     {
      year: "2019-2025",
      title: "Institut Teknologi PLN",
      description: "Menempuh perkkuliahan dengan Jurusan Informatika",
      logo: "/img2/itpln.jpeg",
      current: true,
      organizations: [
        { name: "HIMDA-Himanad" },
        { name: "Organisasi Informatika" },
      ],
    },
  ];
                        ...
                        <div className="flex gap-2 sm:gap-3">
                          {item.childhoodPhotos.map((photo, i) => (
                            <motion.button
                              ...
                              className={`relative w-14 h-14 sm:w-16 sm:h-16 rounded-xl overflow-hidden border ${
                                isLight
  ...
  >
    ...
    >
      ...
      <button
        onClick={() => setSelectedImage(null)}
        className="absolute -top-10 right-0 text-white text-xl font-bold hover:opacity-70"
      >
        ✕
      </button>
