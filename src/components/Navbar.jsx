...
const Navbar = () => {
  ...
  useEffect(() => {
  const handleScroll = () => {
    setDesktopScrolled(window.scrollY > 20)
  }
  ...
  const DesktopNavbar = () => (
  <nav
    className={`hidden md:flex items-center font-sora font-semibold fixed top-0 left-0 z-50 w-full h-20 px-10 transition-all duration-500 ${
      desktopScrolled
        ? isLight
      ...
      <div className="flex items-center">
        <a href="#home" aria-label="Home" className="flex items-center">
          <img
            src="/img2/FAHMI.png"
            alt="Logo"
            className="h-20 w-20 object-contain drop-shadow-lg transition-transform duration-300 hover:scale-100"
          />
        </a>
      </div>
