...
const About = () => {
  ...
  const techStack = useMemo(() => [
    ...
    { name: "Mikrotik", logo: "https://cdn.simpleicons.org/mikrotik" }, 
  ], []);
          ...
          <div className="flex flex-col gap-8 items-center">
            ...
            <div ref={contentRef} className="space-y-6 w-full">
              ...
              <div className={`space-y-4 text-base ${isLight ? 'text-slate-700' : 'text-slate-300'} leading-relaxed`}>
                <p>
                  Halo! Saya Zulfahmi Ridha, seorang Front-End Developer dengan passion dalam 
                  menciptakan solusi digital yang inovatif dan efisien. Dengan pengalaman yang kuat
                  dalam bidang industri teknologi, saya telah mengembangkan berbagai aplikasi web dan 
                  mobile yang tidak hanya fungsional tetapi juga memberikan pengalaman pengguna yang 
                  luar biasa.
                </p>
                <p>
                  Sekarang Saya berusia 24 tahun dan sudah menempuh perkuliahan di ITPLN Jakarta dengan
                  jurusan Teknologi Informasi. Selain itu, saya juga aktif berkontribusi pada 
                  proyek open-source dan terus memperbarui keterampilan saya dengan teknologi terbaru.
                </p>
              </div>
              {/* Call to Action */}
